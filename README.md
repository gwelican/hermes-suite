...
```bash
podman pull ascensionoid/hermes-suite:2026.5.16-0.51.74
```
...
podman build \
  ...
  --build-arg HERMES_WEBUI_VERSION=v0.51.103 \
  -t hermes-suite:2026.5.16-0.51.103 .
```
...
|-----------|---------------|---------------|--------|
| `2026.5.16-0.51.103` | v2026.5.16 | v0.51.103 | amd64 + arm64 |
...
- **WebUI**: semantic version from `nesquena/hermes-webui` (e.g. `v0.51.103`)
...
podman build \
  --build-arg AGENT_VERSION=v2026.5.16 \
  --build-arg HERMES_WEBUI_VERSION=v0.51.103 \
  -t ascensionoid/hermes-suite:2026.5.16-0.51.103 .
```
